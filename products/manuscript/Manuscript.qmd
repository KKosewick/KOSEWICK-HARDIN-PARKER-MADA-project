...
following variables: BMI, cat_bp, Stress Level, Gender, Age, and
Occupation.
...
sleep quality. We found that all of our assumptions were supported; the
results of our generalized linear models (GLMs) are included in the
supplementary material folder as there are too many of them to include
...
![The ranking of each variable's importance in determining sleep quality
according to our Random Forest model.](images/variableimportance.png)
...
![Table 1: A comparison of the RMSE and R-squared values generated by
...
As seen in table 1, our null model was found to have an RMSE of 1.193;
...
Through our linear models (included in the supplementary materials
folder), we determined that our hypotheses regarding each variable's
effect on quality of sleep were supported. The variables determined to
be the most important by our RF model had the following effects on sleep
quality: sleep duration was positively correlated, age was positively
correlated, and stress level was negatively correlated.
...
https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9815923/#:\~:text=Patients%20with%20hypertension%20commonly%20complain,an%20increased%20risk%20of%20insomnia.
